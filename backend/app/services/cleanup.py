...
# NOTE: send_weekly_reminders was removed. The Monday weekly digest is now
# consolidated into scripts/scheduler.py:weekly_digest_loop, which runs the
# combined per-channel composer in app.services.weekly_digest. Keeping a
# duplicate cron loop here would have produced two emails per Monday.
