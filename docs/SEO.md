...
| SEO-21 | P1 | Pillar blog cluster with 10-point validator-enforced quality bar | 🟡 foundation (2026-04-24) — validator shipped (`backend/app/services/blog_validator.py`) enforcing all 10 checks; tier-gated into `blog_publisher.validate_payload` via `pillar_tier` field. Banned-tech-stack list split so pillar posts can mention OpenAI/Anthropic/PyTorch while operational-leak terms stay blocked all tiers. First pillar post (`/blog/ai-engineer-vs-ml-engineer`) is the next deliverable. |
...
**Next action** (always — source of truth for what to pick up next): SEO-00 baseline accumulation is the last P0-gating item (GSC + Bing properties verified + sitemap submitted 2026-04-23; 7-day baseline pending data). SEO-25 + SEO-22/21 foundation shipped 2026-04-24. Highest-leverage remaining work: **first pillar post** at `/blog/ai-engineer-vs-ml-engineer` (q6, most beatable SERP per §5.1) — validator now exists to gate it. After that, the next 5 pillar posts one session each, then SEO-26 quiz landing (worktree + codex:rescue for the Alembic migration). SEO-09, SEO-13, SEO-08, SEO-06, SEO-05, SEO-04, SEO-01, SEO-19, SEO-20, SEO-24, SEO-25 all shipped — see Change log at bottom.
